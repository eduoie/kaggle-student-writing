...
def feature_engineer_split(train_df, train_text_df, MODEL_NAME, train_split, valid_split, random_seed):
...
def main():
    ...
    train_df_ner, valid_df_ner = feature_engineer_split(train_df, train_text_df, model_name, train_split, valid_slit, random_seed)
